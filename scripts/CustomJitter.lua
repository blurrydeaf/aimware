...
local reference 	= gui.Reference("Ragebot");
	local tab 			= gui.Tab(reference, "customjitter", "CustomJitter.lua");
		...
		local aa_left				= gui.Groupbox(tab, "Anti-aim Left ", 220, 10, 200, 1);
			...
			local jitter1_left		= gui.Slider(aa_left, "jitter1_left", "Jitter yaw 1", 1, -180, 180, 1);
			local jitter2_left		= gui.Slider(aa_left, "jitter2_left", "Jitter yaw 2", 1, -180, 180, 1);
		local aa_right				= gui.Groupbox(tab, "Anti-aim Right", 430, 10, 200, 1);
			...
			local jitter1_right		= gui.Slider(aa_right, "jitter1_right", "Jitter yaw 1", 1, -180, 180, 1);
			local jitter2_right		= gui.Slider(aa_right, "jitter2_right", "Jitter yaw 2", 1, -180, 180, 1);
